    ...
    >
      <div className=' register-fir-bg flex flex-col items-center w-[30rem]  px-[2rem] py-[2rem] register-fir-bg  ' >
        <form onSubmit={submitHandler} className=' flex flex-col w-[100%] gap-[1rem] text-[#AEB9E180] ' >
          <label htmlFor={"caption"}>Caption <span className={` text-red-600 `} >*</span></label>
          <textarea
            value={caption}
            onChange={(e) => setCaption(e.target.value)}
            type="textarea"
            className=" resize-none h-[3rem] bg-[#8C8C9A1F]  px-[1rem] py-[.5rem] rounded-md outline-none focus:outline-[#6c71ff5c]"
